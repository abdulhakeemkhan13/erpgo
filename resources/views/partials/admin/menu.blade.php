                ...
                @if( Gate::check('view space') || Gate::check('view spacetype') || Gate::check('manage ismail') || Gate::check('manage vistor'))
                        <li class="dash-item dash-hasmenu
                                ...
                                <li class="dash-item {{ (request()->is('account-assets*') ? 'active' : '')}}">
                                    <a class="dash-link" href="{{route('account-assets.index')}}">{{__('Asset Setup ')}}</a>
                                </li>
                                @endcan
                                @can('manage vistor')
                                <li class="dash-item {{ (Request::segment(1) == 'isvisitor') ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('isvisitor.index') }}">{{__('Vistor')}}</a>
                                </li>
                                @endcan
                                @can('manage ismail')
                                <li class="dash-item {{ (Request::segment(1) == 'ismail') ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('ismail.index') }}">{{__('Mail')}}</a>
                                </li>
                                @endcan
